...
class TestCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.anag_tipologie_istanze_1 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_ordine_contratto')
        cls.anag_tipologie_istanze_2 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_accordi')
        cls.anag_tipologie_istanze_3 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_bandi')
        cls.anag_tipologie_istanze_4 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_concorsi')
        cls.anag_tipologie_istanze_5 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_inviti_convocazioni')
        cls.anag_tipologie_istanze_6 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_conferimento')
        cls.anag_tipologie_istanze_7 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_assunzione')
        cls.anag_tipologie_istanze_8 = cls.env.ref(
            'inrim_controllo_accessi_richieste_accesso.ca_anag_tipologie_istanze_visita')
